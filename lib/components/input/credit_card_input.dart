...
//As you enter the credit card number, you will notice that it adds spaces after the fourth digit. TextInputFormatter allows us to do such things on Flutter. Now let’s create our own CardNumberInputFormatter.
...
// every 2nd number multiply with 2
  ...
  // It is not just the card number that needs to be validated; it is also the CVV and expiration date.
